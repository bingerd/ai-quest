  ...
  modules: [
    {
      ...
      lessons: [
        ...
        { id: 'what-is-an-llm', title: 'What is an LLM?', type: 'explanation', component: WhatIsAnLlm, estimatedMinutes: 1 },
        { id: 'what-is-a-token', title: 'What is a token?', type: 'explanation', component: WhatIsAToken, estimatedMinutes: 1 },
    ...
    },
    {
      ...
      lessons: [
        { id: 'what-is-a-context-window', title: 'What is a context window?', type: 'explanation', component: WhatIsAContextWindow, estimatedMinutes: 1 },
        { id: 'interactive-context-window', title: 'Make it fit', type: 'interactive', component: InteractiveContextWindow, estimatedMinutes: 2 },
        { id: 'context-pollution', title: 'Pollution, repetition and caching', type: 'explanation', component: ContextPollution, estimatedMinutes: 1 },
    ...
    },
    {
      ...
      lessons: [
        { id: 'token-heist', title: 'Challenge: Token Heist', type: 'challenge', challenge: tokenHeistChallenge, estimatedMinutes: 3 },
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: 'model-selection', title: 'Simulation: Model Selection', type: 'challenge', challenge: modelSelectionChallenge, estimatedMinutes: 3 },
        ...
        { id: 'retrieval-lab', title: 'Retrieval lab', type: 'interactive', component: RetrievalLab, estimatedMinutes: 2 },
      ],
    },
    {
      id: 'enterprise',
      ...
      lessons: [
        ...
        { id: 'enterprise-scenario', title: 'Scenario: AI Adoption Lead', type: 'challenge', challenge: enterpriseChallenge, estimatedMinutes: 3 },
        { id: 'final-challenge', title: 'Final Challenge', type: 'challenge', challenge: finalChallenge, estimatedMinutes: 4 },
      ],
    },
  ],
}
